...
console.log(whoIsBigger(43225, 442332));
...
console.log(isThisAnEmail('antonioadadewa@adaw.it'));
console.log(isThisAnEmail('antonioadadewaadaw#adaw.it'));
...
function isTodayMyBirthday() { 
  ...
  return currentDay === 14 && currentMonth === 12;
}
...
*/
// spostato perchè se io lo richiamo negli esercizi ma è dichiarato dopo tutti non funziona 
